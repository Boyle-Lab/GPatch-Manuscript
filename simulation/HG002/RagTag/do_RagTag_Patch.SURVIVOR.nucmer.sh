...
# Run RagTag Patch
/usr/bin/time -v ragtag.py patch --aligner /data/software/Mummer/mummer-4.0.0rc1/bin/nucmer --nucmer-params "--maxmatch -l 100 -c 500 -t 24" -o $OUT_DIR -f 100 -s 10000 $ASSEMBLY_FASTA $REFERENCE_FASTA
